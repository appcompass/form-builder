    ...
    <div class="panel-body">
        ...
        <table class="table table-hover general-table dataTable" id="dynamic-table">
            ...
            <tbody>
                ...
                <tr>
                    @foreach($meta->table->rows as $row_key => $row_data)

                        @if($row_data->type == 'link_by_id')
                            <td>
                                @can('edit', $record)
                                    <a href="{{ $meta->base_url }}/{{ $record->id }}/edit" data-click="{{ $meta->base_url }}/{{ $record->id }}" data-target="#main-content-out">
                                @endcan
                                    {{ $record->$row_key }}
                                @can('edit', $record)
                                    </a>
