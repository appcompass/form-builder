...
<script src="/ui/js/jquery-ui/jquery-ui-1.10.1.custom.min.js"></script>
<script src="/ui/js/jquery.dcjqaccordion.2.7.js"></script>
<script src="/ui/js/jquery.scrollTo.min.js"></script>
<script src="/ui/js/jQuery-slimScroll-1.3.0/jquery.slimscroll.js"></script>
<script src="/ui/js/jquery.nicescroll.js"></script>
<!--[if lte IE 8]><script language="javascript" type="text/javascript" src="/ui/js/flot-chart/excanvas.min.js"></script><![endif]-->
<script src="/ui/js/skycons/skycons.js"></script>
<script src="/ui/js/jquery.scrollTo/jquery.scrollTo.js"></script>
<script src="/ui//cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.3/jquery.easing.min.js"></script>
<script src="/ui/js/calendar/clndr.js"></script>
<script src="http://cdnjs.cloudflare.com/ajax/libs/underscore.js/1.5.2/underscore-min.js"></script>
<script src="/ui/js/calendar/moment-2.2.1.js"></script>
<script src="/ui/js/evnt.calendar.init.js"></script>
<script src="/ui/js/jvector-map/jquery-jvectormap-1.2.2.min.js"></script>
<script src="/ui/js/jvector-map/jquery-jvectormap-us-lcc-en.js"></script>
<script src="/ui/js/gauge/gauge.js"></script>
<!--clock init-->
<script src="/ui/js/css3clock/js/css3clock.js"></script>
<!--Easy Pie Chart-->
<script src="/ui/js/easypiechart/jquery.easypiechart.js"></script>
<!--Sparkline Chart-->
<script src="/ui/js/sparkline/jquery.sparkline.js"></script>
<!--Morris Chart-->
<script src="/ui/js/morris-chart/morris.js"></script>
<script src="/ui/js/morris-chart/raphael-min.js"></script>
<!--jQuery Flot Chart-->
<script src="/ui/js/flot-chart/jquery.flot.js"></script>
<script src="/ui/js/flot-chart/jquery.flot.tooltip.min.js"></script>
<script src="/ui/js/flot-chart/jquery.flot.resize.js"></script>
<script src="/ui/js/flot-chart/jquery.flot.pie.resize.js"></script>
<script src="/ui/js/flot-chart/jquery.flot.animator.min.js"></script>
<script src="/ui/js/flot-chart/jquery.flot.growraf.js"></script>
