...
<!--[if lte IE 8]><script language="javascript" type="text/javascript" src="/assets/ui/js/flot-chart/excanvas.min.js"></script><![endif]-->
<script src="/assets/ui/js/skycons/skycons.js"></script>
<script src="/assets/ui/js/jquery.scrollTo/jquery.scrollTo.js"></script>
<script src="/assets/ui//cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.3/jquery.easing.min.js"></script>
<script src="/assets/ui/js/calendar/clndr.js"></script>
<script src="http://cdnjs.cloudflare.com/ajax/libs/underscore.js/1.5.2/underscore-min.js"></script>
<script src="/assets/ui/js/calendar/moment-2.2.1.js"></script>
<script src="/assets/ui/js/evnt.calendar.init.js"></script>
