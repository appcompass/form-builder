		<section class="panel">
			...
			<div class="panel-body">
				<form class="form-horizontal bucket-form" method="post" action="/cp/websites/{{ $record->id }}/connection" data-redirect="/cp/websites/{{ $record->id }}/connection" data-target="#website-detail">
