          ...
          <section class="panel">
            <div class="panel-body">
              <ul class="nav nav-pills nav-stacked mail-nav">
                <li class="active"><a href="#" data-click="/websites/{{ $website->id }}/pages/{{ $page->id }}/edit" data-target="#record-detail"> <i class="fa fa-list"></i> General Informations </a></li>
                {{-- <li><a href="#" data-click="/websites/{{ $page->id }}/settings" data-target="#record-detail"> <i class="fa fa-list"></i> Website Configuration </a></li> --}}
                @if($page->load('template.sections'))

                  @foreach($page->template->sections as $section)

                      <li><a href="" data-click="/websites/{{ $page->id }}/pages/{{ $page->id }}/section/{{ $section->id }}"  data-target="#record-detail"><i class="fa fa-list"></i>{{ ucfirst($section->name) }}</a></li>
  ...
  {{--              <li> <a href="#"> <i class="fa fa-comments-o text-muted "></i> YGL Sync - New users<span class="label label-success pull-right inbox-notification">9</span><p>Sync operation successful with 9 new addresses</p></a></li>
   ...
   --}}           </ul>
        ...
        <div class="col-sm-9" id="record-detail" data-load="/websites/{{ $website->id }}/pages/{{ $page->id }}/edit"></div>
      </div>
