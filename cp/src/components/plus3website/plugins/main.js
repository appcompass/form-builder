...
if (process.BROWSER_BUILD) {
    ...
    // This is form specific stuff, so we should drop them
    // into the form builder component when that's created.
    // especially since none of this logic will work after
    // the first load with it being referenced here only.
    $(init);
